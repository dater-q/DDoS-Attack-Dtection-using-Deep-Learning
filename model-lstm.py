...
#loading dataset
df = pd.read_csv("New folder/processed-dataset/cicdos2019-multi-train-bin-pr.csv")
...
model.fit(X_train, y_train, epochs=10, batch_size=1000, callbacks=early_stopping , validation_data=(X_test, y_test), shuffle=True, class_weight=None, sample_weight=None, initial_epoch=0)
...
#save model
model.save('model-lstm-bin.keras')

df1 = pd.read_csv('New folder/processed-dataset/cicdos2019-multi-test-bin-pr.csv')
